...
\begin{itemize}
\item \textit{GlobalLock} (referred to in figures as \lstinline|globallock|)
      An instance of the \lstinline|std::priority_queue<T>| class provided
...
\item \textit{Linden} (\lstinline|linden|)
...
\item \textit{SprayList} (\lstinline|spray|)
...
\item \textit{Multiqueues} (\lstinline|multiq|)
...
\item \textit{Pheet \klsm} (\lstinline|pheet16, pheet128, ...|)
...
\item \textit{Standalone \klsm} (\lstinline|klsm16, klsm128, ...|)
      The standalone \klsm
