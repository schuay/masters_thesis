...
pqplot("results/20151109_mars_uni_uni")
@
\end{center}
...
\begin{center}
<<fig = TRUE, width = 10, echo = FALSE>>=
pqplot("results/20151109_mars_uni_uni_slow")
@
\end{center}
...
\begin{center}
<<fig = TRUE, width = 10, echo = FALSE>>=
pqplot("results/20151109_mars_uni_uni_pheet")
@
\end{center}
\caption{Uniform workload, uniform keys on \lstinline|mars|.
...
\begin{center}
<<fig = TRUE, echo = FALSE>>=
pqplot("results/20151109_mars_uni_asc")
@
\end{center}
