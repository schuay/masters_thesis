...
\begin{itemize}
\item \lstinline|mars| (Figure \ref{ref:machine_architecture_mars})
...
\item \lstinline|saturn| (Figure \ref{ref:machine_architecture_saturn})
...
\item \lstinline|ceres| (Figure \ref{ref:machine_architecture_ceres})
