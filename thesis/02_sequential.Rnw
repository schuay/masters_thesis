...
\centering
    \begin{tikzpicture}[
      ...
      \matrix[row sep=0.1mm, column sep=5mm]{
        \nodelabel{3}; & \snode{3a}{}; & & & & & & & \snode{3h}{};\\
        \nodelabel{2}; & \snode{2a}{}; & & \snode{2c}{}; & & \snode{2e}{}; & & & \snode{2h}{};\\
        \nodelabel{1}; & \snode{1a}{}; & & \snode{1c}{}; & \snode{1d}{}; & \snode{1e}{}; & \snode{1f}{}; & & \snode{1h}{};\\
        \nodelabel{0}; & \snode{0a}{}; & \snode{0b}{0}; & \snode{0c}{1}; & \snode{0d}{2}; & \snode{0e}{3}; & \snode{0f}{4}; & \snode{0g}{5}; & \snode{0h}{};\\
      };
