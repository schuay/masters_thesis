...
\end{minipage}
\caption{The same heap displayed once in its native array representation,
...
\centering
    \begin{tikzpicture}[
      ...
      \draw[-] (-2.5mm,-5mm) -- node[below] {\texttt{head}} (2.5mm, -5mm);
      \draw[-] (-2.5mm,-4.5mm) -- (-2.5mm,-5.5mm);
      \draw[-] (2.5mm,-4.5mm) -- (2.5mm,-5.5mm);

      \draw[-] (7.5mm,-5mm) -- node[below] {Items} (62.5mm, -5mm);
      \draw[-] (7.5mm,-4.5mm) -- (7.5mm,-5.5mm);
      \draw[-] (62.5mm,-4.5mm) -- (62.5mm,-5.5mm);

      \draw[-] (67.5mm,-5mm) -- node[below] {\texttt{tail}} (72.5mm, -5mm);
      \draw[-] (67.5mm,-4.5mm) -- (67.5mm,-5.5mm);
      \draw[-] (72.5mm,-4.5mm) -- (72.5mm,-5.5mm);
    \end{tikzpicture}
\caption{A SkipList with 6 elements and a maximal level of 3.
